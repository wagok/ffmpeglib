...
// NotPlayingException
static char *not_playing_exception_class_path_name = "com/wagok/ffmpeg/ffmpeg/NotPlayingException";
...
// FFmpegStreamInfo
static char *stream_info_class_path_name = "com/wagok/ffmpeg/ffmpeg/FFmpegStreamInfo";
...
// FFmpegPlayer
static char *player_class_path_name = "com/wagok/ffmpeg/ffmpeg/FFmpegPlayer";
...
static JavaMethod player_set_stream_info = {"setStreamsInfo", "([Lcom/wagok/ffmpeg/ffmpeg/FFmpegStreamInfo;)V"};
...
static JNINativeMethod player_methods[] = {
	...
	{"saveNative", "(Ljava/lang/String;)V", (void*) jni_player_save},
	...
	{"testLog", "()V", (void*) jni_player_test_log},

    {"ffmpegCMD", "([Ljava/lang/String;)V", (void*) jni_player_ffmpeg_cmd},
};
