...
import com.wagok.ffmpeg.ffmpeg.FFmpegDisplay;
import com.wagok.ffmpeg.ffmpeg.FFmpegError;
import com.wagok.ffmpeg.ffmpeg.FFmpegListener;
import com.wagok.ffmpeg.ffmpeg.FFmpegPlayer;
import com.wagok.ffmpeg.ffmpeg.FFmpegStreamInfo;
import com.wagok.ffmpeg.ffmpeg.FFmpegStreamInfo.CodecType;
import com.wagok.ffmpeg.ffmpeg.NotPlayingException;
...
public class VideoActivity extends Activity implements OnClickListener,
	...
	public void onFFUpdateTime(long currentTimeUs, long videoDurationUs, boolean isFinished) {
		...
		if (!mTracking) {
			int currentTimeS = (int)(currentTimeUs / 1000 );
			int videoDurationS = (int)(videoDurationUs / 1000 );
